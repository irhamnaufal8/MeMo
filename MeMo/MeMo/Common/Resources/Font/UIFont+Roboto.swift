...
extension UIFont {
    ...
    static let robotoHeadline = UIFont(name: "Roboto-Medium", size: 14)
    static let robotoBody = UIFont(name: "Roboto-Regular", size: 14)
    static let robotoCaption = UIFont(name: "Roboto-Regular", size: 12)
